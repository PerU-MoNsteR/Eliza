...
@peru.on(admin_cmd(pattern="pbio (.*)"))  # pylint:disable=E0602
async def _(event):
    if event.fwd_from:
        return
...
@peru.on(admin_cmd(pattern="pname ((.|\n)*)"))  # pylint:disable=E0602,W0703
async def _(event):
    if event.fwd_from:
        return
...
@peru.on(admin_cmd(pattern="ppic"))  # pylint:disable=E0602
async def _(event):
    if event.fwd_from:
        return
...
@peru.on(admin_cmd(outgoing=True, pattern="username (.*)"))
...
@peru.on(admin_cmd(outgoing=True, pattern="count$"))
...
@peru.on(admin_cmd(outgoing=True, pattern=r"delpfp"))
...
@peru.on(admin_cmd(pattern="myusernames$"))
async def _(event):
    if event.fwd_from:
        return
