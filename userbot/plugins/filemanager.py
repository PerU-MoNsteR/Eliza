...
@peru.on(events.NewMessage(pattern=r"\.lslocal", outgoing=True))
async def _(event):
    if event.fwd_from:
        return
...
@peru.on(events.NewMessage(pattern=r"\.lsroot", outgoing=True))
async def _(event):
    if event.fwd_from:
        return
    PROCESS_RUN_TIME = 100
...
@peru.on(events.NewMessage(pattern=r"\.lssaved", outgoing=True))
async def _(event):
    if event.fwd_from:
        return
    PROCESS_RUN_TIME = 100
...
@peru.on(events.NewMessage(pattern=r"\.rnsaved ?(.*)", outgoing=True))
async def _(event):
    if event.fwd_from:
        return
    PROCESS_RUN_TIME = 100
...
@peru.on(events.NewMessage(pattern=r"\.rnlocal ?(.*)", outgoing=True))
async def _(event):
    if event.fwd_from:
        return
    PROCESS_RUN_TIME = 100
...
@peru.on(events.NewMessage(pattern=r"\.delsave (.*)", outgoing=True))
...
@peru.on(events.NewMessage(pattern=r"\.delocal (.*)", outgoing=True))
async def handler(event):
    if event.fwd_from:
        return
    input_str = event.pattern_match.group(1)
