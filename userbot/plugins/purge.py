...
@peru.on(admin_cmd(pattern=r"purge"))
@errors_handler
...
@peru.on(admin_cmd(pattern=r"purgeme"))
@errors_handler
...
@peru.on(admin_cmd(pattern=r"del"))
@errors_handler
...
@peru.on(admin_cmd(pattern=r"edit"))
@errors_handler
...
@peru.on(admin_cmd(pattern=r"sd"))
@errors_handler
