...
@peru.on(admin_cmd(pattern="metoo ?(.*)"))
async def _(event):
    if event.fwd_from:
        return
...
@peru.on(admin_cmd(pattern="rapee ?(.*)"))
async def _(event):
    if event.fwd_from:
        return
...
@peru.on(admin_cmd(pattern="insultt ?(.*)"))
async def _(event):
    if event.fwd_from:
        return
...
@peru.on(admin_cmd(pattern="proo ?(.*)"))
async def _(event):
    if event.fwd_from:
        return
...
@peru.on(admin_cmd(pattern="abusee ?(.*)"))
async def _(event):
    if event.fwd_from:
        return
...
@peru.on(admin_cmd(pattern="geyy ?(.*)"))
async def _(event):
    if event.fwd_from:
        return
