...
async def upstream(ups):
    ...
    try:
        ...
        if conf != "now":
            await ups.edit(f"searching for updates.....\
            \nPlease do type |.update now| to update your Eliza.")
            return
        repo = Repo.init()
    ...
    if HEROKU_API_KEY is not None:
        ...
        await ups.edit("Updating New Update. Please wait for 3 minutes then use `.alive`-to check me..  ")
