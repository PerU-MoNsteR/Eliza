...
async def upstream(ups):
    ...
    if force_updateme:
        ...
        await ups.edit('`Updating your (ELIZA) please weit for 5 mins then type .alive or .help or .ping or .alive or  to see if I am working or not...thanks for using me...❤`')
