...
async def amireallyalive(alive):
    ...
    if ALIVE_PHOTTO:
        ...
        pm_caption += "LICENSE                  :[ӀíϲҽղՏҽ](https://github.com/suhaash02/Eliza/blob/master/LICENSE)\n\n"
        pm_caption += "𝘾𝙊𝙋𝙔𝙍𝙄𝙂𝙃𝙏 𝘽𝙔            : [peru_monster](https://t.me/peru_monster)\n"
    ...
    with BytesIO() as sticker:
        ...
        await borg.send_message(alive.chat_id,"**ELIZA 𝙸𝚂 🅾︎🅽🅻🅸🅽🅴**\n"
                      ...
                      "𝘓𝘐𝘚𝘌𝘕𝘊𝘌                  :[ӀíϲҽղՏҽ](https://github.com/suhaash02/Eliza/blob/master/LICENSE)\n\n"
                      "𝘾𝙊𝙋𝙔𝙍𝙄𝙂𝙃𝙏 𝘽𝙔            : [@peru_monster](https://t.me/eliza_support)\n"
